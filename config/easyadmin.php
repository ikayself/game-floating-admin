...
return [
    ...
    'CF_TURNSTILE_STATUS'     => env('CF_TURNSTILE_STATUS', false),
    'CF_TURNSTILE_SITE_KEY'   => env('CF_TURNSTILE_SITE_KEY', false),
    'CF_TURNSTILE_SECRET_KEY' => env('CF_TURNSTILE_SECRET_KEY', false),
];
