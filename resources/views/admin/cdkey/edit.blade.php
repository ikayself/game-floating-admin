    ...
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="key" class="layui-input"  placeholder="请输入卡密" value="{{$row['key']}}">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">激活时间</label>
            <div class="layui-input-block">
                <input type="text" name="used_time" class="layui-input"  placeholder="请输入激活时间" value="{{$row['used_time']}}">
            </div>
        </div>
        <div class="layui-form-item">
