define(["jquery", "easy-admin"], function ($, ea) {
    ...
    var init = {
        ...
        index_url: 'apps/index',
        add_url: 'apps/add',
        edit_url: 'apps/edit',
        delete_url: 'apps/delete',
        export_url: 'apps/export',
        modify_url: 'apps/modify',
        recycle_url: 'apps/recycle',
    };
